...
export default function BottomNav({ 
  ...
  if (showWhatsAppInput) {
    ...
    let drawerClasses = `${inPreview ? "absolute" : "fixed"} bottom-0 left-0 right-0 mx-auto w-full max-w-[500px] z-[100] px-5 pt-5 pb-6 flex flex-col justify-center pb-safe animate-slideUp border-t`;
    ...
    if (layout === "minimal") {
      ...
      closeBtnClasses += " bg-white/40 hover:bg-white/60 border border-white/50 text-slate-700 rounded-full";
